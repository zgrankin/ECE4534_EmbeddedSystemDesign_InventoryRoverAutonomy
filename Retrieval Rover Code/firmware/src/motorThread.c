...
volatile unsigned int tickLCap = 645; //650 for right turn
volatile unsigned int tickRCap = 645; //650 for right turn
...
void motorsLeft()
{
    setLeftMotor(REVERSE, 67);
    setRightMotor(FORWARD, 70);
}
